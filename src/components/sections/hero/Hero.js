				...
				<div className="banner-left-box">
					<div className="banner-content">
						<span className="sub-title wow fadeInDown" data-wow-delay=".2s">
							<i className="tji-excellence"></i> Smart Transport Solutions
						</span>
						<h1 className="banner-title title-anim">
							Smart Transport, <span>Smarter Solutions.</span>
						</h1>
						<div className="banner-desc-area wow fadeInUp" data-wow-delay=".7s">
							...
							<div className="banner-desc">
								Technology-driven transportation and logistics platform providing seamless, efficient, and reliable cargo delivery across Telangana and Andhra Pradesh.
							</div>
						</div>
					</div>
