	...
	return (
		<section className="h5-about section-gap section-gap-x">
			...
			<div className="bg-shape-1">
				<img src="/images/shape/pattern-2.svg" alt="" role="presentation" />
			</div>
			<div className="bg-shape-2">
				<img src="/images/shape/pattern-3.svg" alt="" role="presentation" />
			</div>
			<div className="bg-shape-3">
				<img src="/images/shape/shape-blur.svg" alt="" role="presentation" />
			</div>
		</section>
	);
};
