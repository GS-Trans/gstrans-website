										...
										<div className="row align-items-center justify-content-between">
											<div className="col-md-4 tj-award-img-wrapper">
												...
												<div className="tj-award-img">
															<Image src={item.img} alt={`${item.result} award ${item.year}`} width={80} height={80} style={{ height: 'auto' }} />
															<Image src={item.img2} alt={`${item.result} award ${item.year}`} width={80} height={80} style={{ height: 'auto' }} />
												</div>
											</div>
